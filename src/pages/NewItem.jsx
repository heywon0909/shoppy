  ...
  return (
    <div className='h-screen'>
      ...
      <section className="flex justify-center p-2 h-screen">
        <article className="w-full max-w-screen-xl pl-4 flex justify-center flex-wrap">
          ...
          <form className="lg:space-y-10 grid gap-4">
            ...
            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">등록하기</button>
          </form>
          </div>
        </article>
      </section>
